...
$knownStandardMembers = [Collections.Generic.HashSet[string]]::new(
    [string[]]@(
        'acquire', 'append', 'arrive_and_wait', 'at', 'back', 'begin', 'c_str', 'clear', 'contains', 'count_down', 'data', 'empty', 'emplace', 'emplace_back', 'end',
        ...
        'notify_all', 'notify_one', 'reserve', 'reset', 'resize', 'size', 'store', 'str', 'substr', 'swap', 'top', 'value', 'wait',
        'value_or'
    )
)
