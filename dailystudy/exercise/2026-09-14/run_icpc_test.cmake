...
# 기대 출력도 파일에서 읽는다. -DEXPECTED=<문자열> 방식과 달리 여러 줄과 세미콜론이
# CMake 목록 구분자로 재해석되지 않으므로 judge 출력을 안전하게 비교할 수 있다.
...
# Windows CRLF와 프로그램이 관례적으로 붙이는 마지막 개행 하나만 양쪽에서 같은 방식으로
# 정규화한다. 그 밖의 공백, 빈 줄, 문자 차이는 그대로 테스트 실패로 남긴다.
string(REPLACE "\r\n" "\n" actual "${actual}")
string(REPLACE "\r\n" "\n" expected "${expected}")
